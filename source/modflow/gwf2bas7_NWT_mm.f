...
C1------WRITE STRESS PERIOD INFORMATION
    ...
    1 FORMAT('1',/28X,'STRESS PERIOD NO. ',I5,', LENGTH =',G15.7,/                                                          ! mm
     1            28X,47('-'),//
...
C
    ...
    9    FORMAT(1X,/9X,'NO FLOW EQUATION TO SOLVE IN TIME STEP',I5,
     1      ' OF STRESS PERIOD',I5,/1X,'ALL HEADS ARE 0.0')                                                                 ! mm
         IPFLG=1
      END IF
C
...
C4------PRINT # OF LAYERS, ROWS, COLUMNS AND STRESS PERIODS.
   ...
   15 FORMAT(1X,I4,' LAYERS',I10,' ROWS',I10,' COLUMNS')
      WRITE(IOUT,20) NPER
   20 FORMAT(1X,I5,' STRESS PERIOD(S) IN SIMULATION')                                                                       ! mm
C
...
C6------IF SO THEN CALL A ULASAV OR ULASV2 TO RECORD DRAWDOWN.
   ...
   74   FORMAT(1X,/1X,'DRAWDOWN WILL BE SAVED ON UNIT ',I4,
     1      ' AT END OF TIME STEP',I5,', STRESS PERIOD ',I5)                                                                ! mm
        IFIRST=0
        IF(CDDNFM.EQ.' ') THEN
...
C
  260 FORMAT('1',/2X,'VOLUMETRIC BUDGET FOR ENTIRE MODEL AT END OF'
     1,' TIME STEP',I5,', STRESS PERIOD',I5/2X,78('-'))                                                                     ! mm
...
C1------TIME STEP.
    ...
    5    FORMAT(1X,/1X,'OUTPUT CONTROL WAS SPECIFIED FOR A NONEXISTENT',
     ...
     3   /1X,'OUTPUT CONTROL STRESS PERIOD ',I5,'   TIME STEP',I5,/                                                         ! mm
     4   1X,'MODEL STRESS PERIOD ',I5,'   TIME STEP',I5,/                                                                   ! mm
...
11       FORMAT(1X,/1X,'NO OUTPUT CONTROL FOR STRESS PERIOD ',I5,                                                           ! mm
     1              '   TIME STEP',I5)
         RETURN
      END IF
C
...
12    FORMAT(1X,/1X,'OUTPUT CONTROL FOR STRESS PERIOD ',I5,                                                                 ! mm
     1              '   TIME STEP',I5)
