...
! Control parameters
      ...
      CHARACTER(LEN=MAXCONTROL_LENGTH), SAVE :: Strmflow_module, Transp_module, Gw_module                                   ! mm
...
! Functions
      ...
      INTEGER, EXTERNAL :: srunoff, srunoff_urban, soilzone                                                                 ! mm
...
! If the Green&Ampt Module is Active, allow for hourly precipitation inputs                                                                     ! PJT - 2018Jan03 - Sub-daily precip inputs
     IF ( Sroff_flag == 4 ) THEN                                                                                                                ! mm: this is safer
