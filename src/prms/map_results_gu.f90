...
!***********************************************************************
      ...
      IF ( Mapflg==0 .OR. Model==99 ) THEN
        IF ( Nhrucell<1 ) THEN
          ...
          ENDIF
        ENDIF
        ALLOCATE ( Gvr_map_frac(Nhrucell), Gvr_hru_id(Nhrucell), Map_var_id(Ngwcell), Map_var_id_sngl(Ngwcell) )            ! mm
...
!***********************************************************************
      ...
      USE PRMS_MAP_RESULTS
      USE PRMS_MODULE, ONLY: Nhru, Nhrucell, Start_month, Start_day, End_year, End_month, End_day, Gvr_cell_id, Print_debug ! mm
      ...
      IF ( Binresults==1 ) THEN                                                                                             ! mm begin
          ...
          DO jj = 1, NmapOutVars
            ...
            ELSE
              ...
              DO k = 1, Nhrucell
                IF ( Gvr_map_frac(k)<NEARZERO ) CYCLE
                Map_var_id_sngl(Gvr_cell_id(k)) = Map_var_id_sngl(Gvr_cell_id(k)) + &
